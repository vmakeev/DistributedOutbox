    ...
    public partial class SelectSequenceNamesQuery
    {
        ...
        protected virtual string GetQueryText()
        {
            if (_cachedSql == null)
            {
                ...
                {
                    using (Stream stream = typeof(SelectSequenceNamesQuery).Assembly.GetManifestResourceStream("DistributedOutbox.Postgres.Queries.SelectSequenceNamesQuery.sql"))
                    {
        ...
        /// <summary>
        /// Выполняет ленивую загрузку значений типа <see cref="string"/>
        /// </summary>
        /// <param name="connection">Подключение к БД</param>
        /// <param name="limit">limit</param>
        /// <param name="cancellationToken">Токен отмены</param>
        /// <returns>Значения типа  <see cref="string"/></returns>
        public virtual async IAsyncEnumerable<string> GetAsync(DbConnection connection, long? limit, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            ...
            {
                yield return GetScalarFromRecord<string>(reader);
            }
        }
