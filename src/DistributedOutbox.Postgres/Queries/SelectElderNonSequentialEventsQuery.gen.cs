    ...
    public partial class SelectElderNonSequentialEventsQuery
    {
        ...
        protected virtual string GetQueryText()
        {
            if (_cachedSql == null)
            {
                ...
                {
                    using (Stream stream = typeof(SelectElderNonSequentialEventsQuery).Assembly.GetManifestResourceStream("DistributedOutbox.Postgres.Queries.SelectElderNonSequentialEventsQuery.sql"))
                    {
        ...
        public virtual async IAsyncEnumerable<PostgresOutboxEventRaw> GetAsync(DbConnection connection, long? limit, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
